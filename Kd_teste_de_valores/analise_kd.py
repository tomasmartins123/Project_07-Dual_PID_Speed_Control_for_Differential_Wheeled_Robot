...
# ==============================================================================
# FIGURA 1: VISÃO CONTINUADA DOS ENSAIOS (RPM e PWM)
# ==============================================================================
...
ax1.set_title('Ensaio de Resposta do Controlador PID (Kd Variável)', fontsize=14, fontweight='bold')
...
for ensaio in ensaios:
    ...
    # Anotação do Kd no gráfico superior
    ax1.text(t_inicio + 0.3, ax1.get_ylim()[0] + 12, f'Kd = {kd_val:.2f}', 
             fontweight='bold', bbox=dict(boxstyle='round,pad=0.3', facecolor='yellow', alpha=0.5))

plt.tight_layout()

# ==============================================================================
# FIGURA 2: COMPARAÇÃO SOBREPOSTA DOS 5 Kd
# ==============================================================================
...
for i, ensaio in enumerate(ensaios):
    ...
    ax3.plot(t_relativo, df_sub['RPM_Medido'], label=f'Kd = {kd_val:.2f}', color=cores[i], linewidth=2)
...
ax3.set_title('Comparação Direta de Resposta para Diferentes Valores de Kd', fontsize=13, fontweight='bold')
ax3.legend(loc='lower right', frameon=True)
ax3.grid(True, linestyle='--', alpha=0.7)

plt.tight_layout()

# Guardar as duas imagens do ensaio Kd
fig1.savefig('ensaio_kd_continuado.png', dpi=300, bbox_inches='tight')
fig2.savefig('ensaio_kd_comparacao.png', dpi=300, bbox_inches='tight')
