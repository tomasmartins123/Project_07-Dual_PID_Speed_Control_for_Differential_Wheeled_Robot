...
ax1.set_title('PID Controller Response Test (Variable Kd)', fontsize=14, fontweight='bold')
...
# Identify the 5 Kd test phases in the graph
...
for trial in trials:
    ...
    # Kd annotation on the top plot
    ax1.text(start_time + 0.3, ax1.get_ylim()[0] + 12, f'Kd = {kd_val:.2f}', 
             fontweight='bold', bbox=dict(boxstyle='round,pad=0.3', facecolor='yellow', alpha=0.5))

plt.tight_layout()

# ==============================================================================
# FIGURE 2: OVERLAID COMPARISON OF THE 5 Kd VALUES
# ==============================================================================
...
for i, trial in enumerate(trials):
    ...
    ax3.plot(relative_time, df_sub['Measured_RPM'], label=f'Kd = {kd_val:.2f}', color=colors[i], linewidth=2)
...
ax3.set_title('Direct Response Comparison for Different Kd Values', fontsize=13, fontweight='bold')
ax3.legend(loc='lower right', frameon=True)
ax3.grid(True, linestyle='--', alpha=0.7)

plt.tight_layout()

# Save both images for the Kd test
fig1.savefig('kd_test_continuous.png', dpi=300, bbox_inches='tight')
fig2.savefig('kd_test_comparison.png', dpi=300, bbox_inches='tight')
