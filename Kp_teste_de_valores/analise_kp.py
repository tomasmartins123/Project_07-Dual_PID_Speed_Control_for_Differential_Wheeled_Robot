...
# ==============================================================================
# FIGURA 1: VISÃO CONTINUADA DOS 25 SEGUNDOS (RPM e PWM)
# ==============================================================================
...
ax1.set_title('Ensaio de Resposta do Controlador Proporcional (Kp Variable)', fontsize=14, fontweight='bold')
...
# Identificar as 5 fases de Kp no gráfico
...
for ensaio in ensaios:
    ...
    # Anotação do Kp no gráfico superior
    ax1.text(t_inicio + 0.3, ax1.get_ylim()[0] + 12, f'Kp = {kp_val:.2f}', 
             fontweight='bold', bbox=dict(boxstyle='round,pad=0.3', facecolor='yellow', alpha=0.5))

plt.tight_layout()

# ==============================================================================
# FIGURA 2: COMPARAÇÃO SOBREPOSTA DOS 5 Kp (0 a 5s)
# ==============================================================================
...
for i, ensaio in enumerate(ensaios):
    ...
    ax3.plot(t_relativo, df_sub['RPM_Medido'], label=f'Kp = {kp_val:.2f}', color=cores[i], linewidth=2)
...
ax3.set_title('Comparação Direta de Resposta para Diferentes Valores de Kp', fontsize=13, fontweight='bold')
