...
## 🎛️ Digital Signal Filtering (EMA Filter)
...
1. **Upload Arduino Code:**
   Open `arduino/dual_pid_control.ino` in the Arduino IDE and flash it to the microcontroller board.
2. **Run Data Logger:**
   Close the Serial Monitor in the Arduino IDE and execute the serial logging script in your terminal:
   ```bash
   python python/pid_logger.py
   ```